...
[ADR 0001](https://github.com/bowenlabs/louise-toolkit/blob/main/docs/adr/0001-opinionated-astro-cloudflare.md)—_opinionated
Astro-on-Cloudflare, fully typed_—reads like an Astroid decision
